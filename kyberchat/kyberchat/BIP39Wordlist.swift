...
// This list is part of the BIP39 specification and is not subject to copyright.
...
enum BIP39Wordlist {
    static let words: [String] = [
        ...
        "any","apart","apology","appear","apple","approve","april","arcade","arctic","area",
        ...
        "fragile","frame","frequent","fresh","friend","fringe","frog","front","frown","frozen",
        ...
        "hip","hire","history","hobby","hockey","hold","hole","hollow","home","honey",
        ...
        "kitten","kiwi","knee","knife","knock","know","lab","ladder","lake","lamp",
        "language","laptop","large","later","laugh","laundry","lava","lawn","lawsuit","layer",
        "lazy","leader","learn","leave","lecture","left","leg","legal","legend","leisure",
        ...
        "lunar","lunch","luxury","mad","magic","magnet","maid","main","mammal","man",
        ...
        "misery","mistake","mix","mixed","mixture","mobile","model","modify","mom","monitor",
